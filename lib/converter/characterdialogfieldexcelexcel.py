...
class CharacterDialogFieldExcelConverter:
    ...
    def en_to_jp_convert(self):
        ...
        excelhelper.write_exceltable_json(self.output_path, serializable_data)
        print("Successfully converted CharacterDialogFieldExcel.json")

    def jp_to_jp_convert(self):
        # Read JSON files
        old_jp_data = excelhelper.read_exceltable_json(self.reference_path)
        new_jp_data = excelhelper.read_exceltable_json(self.source_path)
